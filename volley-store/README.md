...
- [Estructura y responsabilidades de los componentes](#-estructura-y-responsabilidades-de-los-componentes)
- [Uso de React Context](#-uso-de-react-context)
- [Flujo del carrito](#-flujo-del-carrito)
- [Firebase y Firestore](#-firebase-y-firestore)
- [Ejemplos de documentos de Firestore](#-ejemplos-de-documentos-de-firestore)
...
2. Construye el objeto `order`.
3. Calcula el total.
4. Envía la orden a Firestore.
5. Obtiene el ID generado.
6. Muestra la confirmación al usuario.
7. Vacía el carrito.
